...
\lstinputlisting[caption={Kernel making use of \emph{private memory}.},label={private_memory_kernel}, 
                style=customc]{/Users/lalanne/MyCode/GitHubProjects/OpenCLNotes/src/code/private_memory.c}

\lstinputlisting[caption={Kernel making use of \emph{private memory} and \emph{local memory}.},label={private_local_memory_kernel}, 
                style=customc]{/Users/lalanne/MyCode/GitHubProjects/OpenCLNotes/src/code/private_local_memory.c}

\lstinputlisting[caption={Blocking \emph{kernel}.},label={tiling}, 
