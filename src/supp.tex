...
\lstinputlisting[float,caption={Nbody host pseudo code.},label={nbody_host}, 
                style=customc]{/Users/clalanne/GitHubProjects/OpenCLNotes/src/code/nbody_host.c}

\lstinputlisting[float,caption={Nbody kernel pseudo code.},label={nbody_kernel}, 
                style=customc]{/Users/clalanne/GitHubProjects/OpenCLNotes/src/code/nbody_kernel.c}
